  ...
  const rules: IRules[] = [
    {
      ...
      description:
        "They have some numbers written on them. Those numbers indicate how many bridges can be attached to them. You can build up to 2 bridges between same islands. " +
    ...
    },
    {
      ...
      description:
        "If you hover over the island, it will show you all of the possible bridges that can be attached to it. " +
    ...
    },
    {
      ...
      description:
        "Don't worry. In case you make any mistakes you can just delete all of the bridges between same islands. " +
    ...
    },
    {
      ...
      description:
        "If every island is connected with others in a correct way, you completed your puzzle.",
    ...
    },
    {
      ...
      description:
        "When it comes to multiplayer the first step is to create a game room. Game room is a hub for you and your " +
    ...
    },
    {
      ...
      description:
        "Don't worry, you can always try again there is no penalty for entering a wrong password. But do remember that in a first place you should ask your friend for it!",
    ...
    },
    {
      ...
      description:
        "No worries! If there are nice, they will simply wait for you. In case you struggled with a certain board there is always an option of saving the puzzle for later and contutiung playing with your friends.",
