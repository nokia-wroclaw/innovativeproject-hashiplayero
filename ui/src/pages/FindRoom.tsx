...
import { Button, InputBase, Grid, MenuItem, FormControl, InputLabel } from "@mui/material";
      ...
      <div className="rooms">
        <Grid container className="header filter">
            ...
            <Grid item xs={12} sm={6} md={3} className="header-element element">
                <GridOn />
                <FormControl variant="standard" sx={{ m: 1, minWidth: 120,paddingBottom: "16px" }} size="small">
                  <InputLabel id="room-search-board-difficulty-label">Board difficulty</InputLabel>
                  <Select
            ...
            <Grid item xs={12} sm={6} md={3} className="header-element element">
                <Groups />
                <FormControl variant="standard" sx={{ m: 1, minWidth: 120, paddingBottom: "16px" }} size="small">
                  <InputLabel id="room-search-people-number-label">Number of people</InputLabel>
                  <Select
